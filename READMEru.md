...
- full-stack разработчик в СЦ [Транстелематика](https://transtelematica.ru/) (2023 - по сей день)
...
Сейчас я Full-stack разработчик в СЦ Транстелематика. Моя основная задача — разработка систем управления трансляциями для экранов общественного транспорта.
