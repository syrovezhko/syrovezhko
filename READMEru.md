...
По рекомендации знакомого синьер-разработчика из Luxoft Russia я начал осваивать Vue.js. Сделал свое первое FullStack веб-приложение. Я использовал Vue.js, Express.js, SqLite DB. Как и с другими проектами, [можете взглянуть](https://syrovezhko.github.io/tab-tracker/client/dist).
